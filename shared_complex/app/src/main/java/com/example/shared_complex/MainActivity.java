package com.example.shared_complex;
...
public class MainActivity extends AppCompatActivity {
    ...
    String []winnersArray = {"Ashutosh","Mansi","Deep"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences=this.getSharedPreferences("com.example.shared_complex", Context.MODE_PRIVATE);
